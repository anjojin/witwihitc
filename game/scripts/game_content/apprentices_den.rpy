...
label ad3:
    ...
    if quest_check_clover.started:
        ...
        if quest_report_clover.completed:
            ...
            fa "She's so hard-headed. No way she'd ever let a stupid cough kill her."
            r "... You're right."
        ...
        if quest_babysitting.cancelled:
            ...
            if quest_miracle_worker.started:
                menu:
                    c "Did you manage to find what he asked for?"
...
label ad3_offer_catmint:
    ...
    t "I want you to have it, Cloverpaw."
    c "What?!"
    c "Are you insane? What do you want to give me a thing like that to {i}me{/i} for? I'm perfectly healthy!"
    t "I just heard you sneezing earlier, and figured maybe --"
    c "Oh, so he can't even be bothered to take me on patrol, but after hearing me sneeze one time, suddenly, he's the hero."
    c "Get real, Talonclaw. Give those herbs to somecat who actually needs them."
    c "As for me, I'm not interested."
    t "But --"
    play sound "sfx/rustle.mp3"
    play audio "sfx/impact.mp3"
    hide clover_sit_n with fade
...
label ad3_check_clover:
    ...
    c "How many times do I have to tell you? If Talonclaw says I'm fine, I'm fi--"
    t "Cloverpaw?"
    c "..."
    ...
    t "Have there been any changes since when we talked last?"
    c "Well, I've been communing with my warrior ancestors who helped me to discover the healing power of friendship, so I guess you could say I'm basically cured."
    t "Come on, Cloverpaw."
    t "Talk to me."
    c "I am talking."
    t "How long do you think you can avoid seriously confronting this?"
    hide clover_sit_n
    show clover_roll_n
    ...
    c "Remind me of something: how many family members have you lost this leafbare?"
...
label ad3_harsh:
    ...
    hide clover_roll_n
    show clover_stand_n
    c "Yeah. I know. They already moved their nests to one side of the den."
    c "I thought I could at least pretend things were normal for a little while longer, but now all my friends hate me {i}and{/i} I'm going to die."
    t  "Don't say that."
    jump ad3_cont
...
label ad3_cont:
    ...
    hide clover_stand_n 
    show clover_sit_n
    c "Yeah. And, that agreement works for tonight, while we still don't know."
    ...
    t "... I don't think Briarstar is up for any kind of ceremony right now."
    t "In fact, I'd be a bit shocked if Briarstar even remembers who your mentor is."
    c "Heh."
    c "Figures."
    c "She really is a dirtheap."
    c "... Must be getting awfully crowded up in Silverpelt."
    c "Do you believe in what Sunshadow was saying, earlier?"
    menu:
        c "That they're having it as rough as we are?"
        "Yes":
            jump ad3_yes
        "No":
            jump ad3_no 
...
label ad3_yes:
    t "... I do."
    t "The StarClan I know would have never let ThunderClan go through something like this."
    t "They would have done something to stop it."
    t "Send a prophecy. An omen. I don't know."
    t "They wouldn't just be silent."
...
label ad3_no:
    t "... I don't."
    t "StarClan, he'd probably burst a blood vessel if he heard me saying that. But it's true."
    t "I guess there's just something comforting about believing that there's still a paradise up there."
    t "Even while there's so much suffering down below."
    c "Why do you think they let this happen?"
    t "... I'm not sure."
    jump ad3_cont2
...
label ad3_cont2:
    t "I guess we'll never really know, until we join them up there."
    t "It's always been sort of mysterious how they work."
    c "... When kits die, do you think they stay kits forever?"
    c "Or, do StarClan cats never get the chance to grow up?"
    ...
    c "Will I understand more, up there?"
    c "Will I be braver?"
    c "Or is this just ... it?"
    c "This is the sad, stupid version of my soul that's going to be beamed up into the sky."
    ...
    c "'Unless by 'it', you mean 'up both of her lungs.''"
...
label ad3_ending:
    ...
    c "T-Talonclaw, this is really nice, and all, but --"
    t "Too late!"
    c "But I don't know if I really --"
    t "It's already happening. Nothing can stop it, now."
    c "But --"
    t "Shh! You're not supposed to talk during your ceremony."
    c "{i}*Snrk*{/i} Okay, okay ..."
    t "Have you thought of a warrior name that you like?"
    c "Oh, c'mon. That's totally cheating!"
    t "Don't lie. I know you've had one picked out for moons."
    c "..."
    c "... Cloverfang."
