label start:
    ...
    label sun_speech:
        ...
        s "How could StarClan, in its endless power and wisdom, possibly allow it to happen?"
        s "How could they not have warned us?"
        s "..."
        s rising "... It's been nearly four moons, since then." 
        s "I haven't been back to the Moonpool, but it's probably covered in ice and snow, now. Just like the rest of the forest."
        s "In that time, ThunderClan has undergone a tremendous transformation."
        s "I think it's safe to say that all of us have seen things that we'd rather forget."
        ...
        s_unknown "Just five days ago, she gave birth to our first litter."
        ...
        s_unknown "They don't even know what her face looks like."
        hide dapplefeather bg
        s sitting "..."
        s "Of course, it was only a matter of time."
        s "Dapplefeather's body was sick and weak from the hunger, as so many of ours are now."
        s "When she finally passed, I can't even say I was shocked."
        ...
        s_unknown "I hope the pain hasn't stopped."
        ...
        s_unknown "And, if that's true, then I won't stop until every last speck of light is clawed from the sky."
