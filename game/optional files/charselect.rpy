...
init python:
    ...
    g.button("char_01_button")
    g.unlock_image("char01")
...
image char01 = "gallery/vertical/char01_vertical.png"
image char01_locked = "gallery/vertical/char03_vertical.png"
...
screen charselect():
    ...
    fixed:
        ...
        grid 2 2:
            add g.make_button(char_01_button, char01, char01_locked)
